...
- **Breadcrumb bar** — path crumbs, filename crumb → directory file picker (folders first, current file pre-selected, folder drill-in, pick opens a new tab in the clicked pane), symbol crumbs, sibling picker, locals drill-down, marquee scroll footer
