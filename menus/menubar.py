...
def build_menubar(app) -> Menu:
    ...
    file_menu.add_separator()
    file_menu.add_command(label="Close Tab",         command=app.file_close,     accelerator="Ctrl+W")
    file_menu.add_separator()
    ...
    edit_menu.add_command(label="Select All",        command=app.edit_select_all,   accelerator="Ctrl+A")
    edit_menu.add_separator()
    edit_menu.add_command(label="Find & Replace...", command=app.edit_find_replace, accelerator="Ctrl+F")
    ...
    view_menu.add_command(label="Change Font...", command=app.view_change_font, accelerator="Ctrl+L")
    ...
    view_menu.add_command(label="Active Line Color...", command=app.view_active_line_color)
    view_menu.add_separator()
    view_menu.add_checkbutton(
