...
- **Autocomplete** — dropdown with kind labels (function, class, variable, etc.); ↑↓ to navigate, Tab/Enter to accept, Escape to dismiss. The popup is themed from the active color scheme (background, text, and selection colors follow the current theme)
