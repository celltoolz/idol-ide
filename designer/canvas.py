...
class DesignerCanvas(tk.Canvas):
    def __init__(
        ...
        **kwargs,
        ...
        self.bind("<Left>",            lambda _: self._nudge(-GRID,    0))
        self.bind("<Right>",           lambda _: self._nudge( GRID,    0))
        self.bind("<Up>",              lambda _: self._nudge(    0, -GRID))
        self.bind("<Down>",            lambda _: self._nudge(    0,  GRID))
